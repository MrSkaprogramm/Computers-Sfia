...
@XmlType(name = "speaker",
    propOrder = {"origin", "price", "energyConsumption", "type", "critical", "soundPower"})
public class Speaker implements Serializable {
  private static final long serialVersionUID = 6424892392566560348L;
  ...
  @XmlElement(name = "soundPower", required = true)
  ...
  public int hashCode() {
    ...
    result = prime * result + soundPower;
  ...
  public boolean equals(Object obj) {
    ...
    if (Double.doubleToLongBits(price) != Double.doubleToLongBits(other.price))
      return false;
    if (soundPower != other.soundPower)
      return false;
    if (type != other.type)
      return false;
    return true;
  ...
  public String toString() {
    return "Speaker [origin=" + origin + ", price=" + price + ", energyConsumption="
        + energyConsumption + ", type=" + type + ", critical=" + critical + ", soundPower="
        + soundPower + "]";
  }
