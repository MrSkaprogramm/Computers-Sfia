...
@XmlType(name = "keyboard",
    propOrder = {"origin", "price", "energyConsumption", "type", "critical", "lights"})
public class Keyboard implements Serializable {
  private static final long serialVersionUID = 8129077704812919054L;
  ...
  public String toString() {
    return "Keyboard [origin=" + origin + ", price=" + price + ", energyConsumption="
        + energyConsumption + ", type=" + type + ", critical=" + critical + ", lights=" + lights
        + "]";
  }
